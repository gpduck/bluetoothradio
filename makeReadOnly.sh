...
echo -e "tmpfs\t/tempfs\ttmpfs\tdefaults,size=30M\t0\t0" >> /tmp/fstab
 
echo -e "mount_unionfs\t/etc\tfuse\tdefaults\t0\t0" >> /tmp/fstab
echo -e "mount_unionfs\t/var\tfuse\tdefaults\t0\t0" >> /tmp/fstab
echo -e "mount_unionfs\t/home\tfuse\tdefaults\t0\t0" >> /tmp/fstab
echo -e "mount_unionfs\t/root\tfuse\tdefaults\t0\t0" >> /tmp/fstab
echo -e "mount_unionfs\t/tmp\tfuse\tdefaults\t0\t0" >> /tmp/fstab
